package TLS.Basket.SpecificTests.QC_1694_BlockingOfOrdersByIndexesDueToCOVID_19;
...
public class QC_1695_CheckAddressBlockingOnAddressPage {
    ...
    public void testBlockingPlzOnAddressPage(String route) throws IOException {
        ...
        new Product_page_Logic().addProductToCart()
                ...
                .checkingCOVID19Block("ES", plzES, file, "TLS")
                .checkingCOVID19Block("IT", plzIT, file, "TLS")
                .checkingCOVID19Block("PT", plzPT, file, "TLS");
    }
}