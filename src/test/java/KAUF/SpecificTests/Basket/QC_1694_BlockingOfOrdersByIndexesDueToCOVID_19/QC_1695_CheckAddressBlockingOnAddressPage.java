package KAUF.SpecificTests.Basket.QC_1694_BlockingOfOrdersByIndexesDueToCOVID_19;
...
public class QC_1695_CheckAddressBlockingOnAddressPage {
    ...
    Object[] dataProviderProducts() throws SQLException {
        return new SetUp("KAUF").setUpShopWithSubroutes("prod", "DE", "main", "product");
    }
    ...
    public void testBlockingPlzOnAddressPage(String route) throws IOException {
        ...
        new Product_page_Logic().addProductToCart()
                ...
                .checkingCOVID19Block("ES", plzES, file, "KAUF")
                .checkingCOVID19Block("IT", plzIT, file, "KAUF")
                .checkingCOVID19Block("PT", plzPT, file, "KAUF");
    }
}