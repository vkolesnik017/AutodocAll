package PKW.Section_ACC.QC_1810_BlockWithProductsOnChemistryListing;
...
public class QC_1811 {
    ...
    public void testCheckingPresenceProductsListingBlockAndNumberOfProducts(String route) {
        openPage(route);
        new Listing_chemicals_page_Logic().checkingPresenceProductsListingBlock()
