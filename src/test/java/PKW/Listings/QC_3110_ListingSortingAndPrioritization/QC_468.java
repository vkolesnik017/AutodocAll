...
public class QC_468 {
    ...
    Object[] dataProvider() throws SQLException {
        return new Common.SetUp("PKW").setUpShopWithSubroutes("prod", "DE", "main", "car_parts8");
    }

    @Test(dataProvider = "routes")
    @Flaky
    @Owner(value = "Chebanenko")
    @Description(value = "Comparing products between listing modes and check presence elements on Search listing")
    public void testCompareProductsBetweenListingViewModesOnSearchListing(String route) {
        openPage(route);
