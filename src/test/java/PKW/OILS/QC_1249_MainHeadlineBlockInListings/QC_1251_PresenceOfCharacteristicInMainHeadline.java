...
public class QC_1251_PresenceOfCharacteristicInMainHeadline {
    ...
    Object[] dataProvider() throws SQLException {
        return new PKW.SetUp().setUpShopWithSubroutes("prod", "DE", "main", "motoroil_brand,motoroil_maker,motoroil_maker_group,motoroil_chemical_type,motoroil_specification");
    }
    ...
    Object[] dataProviderViscosity() throws SQLException {
        return new PKW.SetUp().setUpShopWithSubroutes("prod", "DE", "main", "motoroil_viscosity");
    }
