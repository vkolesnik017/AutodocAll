...
public class QASYS_476_RenameGroupAndModelInSelector {
    private final String dataFile = "C://Autotests/files/data/QASYS_476_data.xls";
    private final String result = "C://Autotests/files/res/QASYS_476_result.txt";
...
//        String modelTextBeforePars = modelFromSelectorText;
        modelFromSelectorText = substring_2(model, modelFromSelectorText, startUrl);

        if (!brand.equals(markFromSelectorText))
            writer(result, true, "brand" + "#" + makerId + "#" + modelId + "#" + groupId + "#" + brand + "#" + markFromSelectorText + "#" + startUrl);

        if (!model.equals(modelFromSelectorText))
            writer(result, true, "model" + "#" + makerId + "#" + modelId + "#" + groupId + "#" + model + "#" + modelFromSelectorText + "#" + startUrl);
    ...
    private String calculateUrlPkw(String shopFromTest) {
        String shop = null;
        switch (shopFromTest) {
            case "DE":
