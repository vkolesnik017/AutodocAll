...
public class QC_79_GenericOfProductInTopBLock {
    ...
    @Description(value = "Test check product's generic from TOP block")
    public void testChecksProductsGenericFromTopBlock(String route) {
        openPage(route);
        new LKW_Category_page_Logic()
                .ratioOfProductsGenericToCategory();
    }
