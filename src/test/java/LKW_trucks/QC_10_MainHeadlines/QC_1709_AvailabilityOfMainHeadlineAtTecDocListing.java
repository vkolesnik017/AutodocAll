...
public class QC_1709_AvailabilityOfMainHeadlineAtTecDocListing {
    ...
    Object[] dataProvider() throws SQLException {
        return new SetUp().setUpShopWithSubroutes("subprod", "DE", "lkw_main", "lkw_categories_maker,lkw_category_car_list10");
    }
