...
public class QC_1703_AvailabilityOfHeadlineInTecDocCatalogAndModelCatalog {
    @BeforeClass
    void setUp() {
    ...
    Object[] dataProvider() throws SQLException {
        return new SetUp().setUpShopWithSubroutes("subprod", "DE", "lkw_main", "lkw_category_car_list11,lkw_maker_car_list2");
    }
