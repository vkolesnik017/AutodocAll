...
public class QC_480_ValidationRequiredEmailFieldOnSoft404 {
  ...
  @Description(value = "Checks validation of required fileds on soft 404")
  public void testValidationRequiredEmailFieldOnSoft404(String route) {
    openPage(route);
