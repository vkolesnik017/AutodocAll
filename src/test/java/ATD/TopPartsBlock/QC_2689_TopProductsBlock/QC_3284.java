...
public class QC_3284 {
    ...
    @Description(value = "Test check displaying of TOP product pop-up")
    public void testChecksDisplayingTopProductPopUp(String route) {
        openPage(route);
        new Supplier_brand_line_page_Logic()
                .presenceTopProductsBlock()
                .displayOfTopProductPopUp();
    }
