...
public class QC_3099 {


    private String mail = "qc_3099_plusProAutotest@mailinator.com";
    private String idCustomer = "28677587";
    ...
    @Description(value = "Test Checking the absence of a 20% discount for a user with ATD PRO when ordering FR -> FR from the AWS")
