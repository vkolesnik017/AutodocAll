...
public class QC_3070_CheckDiscount20PercentOnSOWithBasicMVP2OrderFront {
    ...
    private String mail = "qc_3070_plusBasicAutotest@mailinator.com";
    ...
    @Description(value = "Test Checking the 20% discount on SO for a user with the BASIC MVP2 package when ordering from the front")
    public void testCheckDiscount20PercentOnSOWithBasicMVP2OrderFront(String route) throws Exception {
        openPage(route);
