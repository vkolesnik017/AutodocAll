...
public class QC_3071_CheckDiscount35PercentOnSOWithOptimumMVP2OrderFront {
    ...
    private String mail = "qc_3071_plusOptimalAutotest@mailinator.com";
    ...
    @Description(value = "Test Checking the 35% discount on SO for a user with the Optimal MVP2 package when ordering from the front")
    public void testCheckDiscount35PercentOnSOWithOptimumMVP2OrderFront(String route) throws Exception {
        openPage(route);
