...
public class QC_2813_CompareOfIncompleteDangerousProductLabelWithOutPictogramAndLabels {
    private final String file = "C://Autotests/files/data/QC_2811.xls";
    private ProductCard_aws productPageAws = new ProductCard_aws("1888884");
    ...
    Object[] dataProvider() throws SQLException {
        return new SetUp("ATD").setUpShopWithSubroutes("prod", "DE", "main", "product62");
    }

    @Test(dataProvider = "routes")
    @Flaky
    @Owner(value = "Kolesnik")
    @Description(value = "test Verify that the display of 'incomplete ( with out pictogram and dangerous labels)' dangerous products labeling in AWS and on the product page matches")
