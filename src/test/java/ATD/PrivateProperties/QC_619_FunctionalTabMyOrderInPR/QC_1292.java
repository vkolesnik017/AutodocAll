...
public class QC_1292 {
    ...
    @Description(value = "Checking the availability of items in the order details card")
    public void testCheckItemsInTheOrderDetailsCard() throws SQLException {
        String mail = "QC_1292_autotest@mailinator.com";
        ...
        new Payment_handler_page_Logic().profilePlusBtnClickInHeader()
                ...
                .checkPresenceElementsInDetailsCard();
