...
public class QC_405_FiltersSorting_TestPriceFilterOnTecdocListing {
    ...
    @Description(value = "Test checks price filter on Tecdoc listing")
    public void checkPriceFilterTecdocListing() throws SQLException {
