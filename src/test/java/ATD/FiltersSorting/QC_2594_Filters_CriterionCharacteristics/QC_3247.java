...
public class QC_3247 {
    ...
    @Description(value = "Test checks display of OEM-Freigabe filter in sidebar")
    public void testCheckPresenceOfOemFreigabeFilterInSidebar(String route) {
        openPage(route);

        new Motoroil_brand_page_Logic()
                .displayOemFreigabeFilterInSidebar();
    }
