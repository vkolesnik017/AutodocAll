...
public class QC_360_MainImageOfChildCategory {
    @BeforeClass
    void setUp() {
    ...
    @Description(value = "Test checks main image of child category")
    public void testChecksMainImageOfChildCategory(String route) {
        openPage(route);

        new Moto_Category_page_Logic()
                .presenceOfMainImageAtChildCategory();
    }
