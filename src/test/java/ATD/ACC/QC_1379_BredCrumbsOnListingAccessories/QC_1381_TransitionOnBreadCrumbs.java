...
public class QC_1381_TransitionOnBreadCrumbs {
    ...
    public void testCheckTransitionForThreeBreadCrumbs(String route) {
        openPage(route);
        listing_accessories_page_logic.checkingPresenceAndWorkThirdBreadCrumb()
                .checkingTransitionAfterClickSecondBreadCrumb();
                checkingContainsUrl("autozubehoer");
                back();
        listing_accessories_page_logic.checkingTransitionAfterClickFirstBreadCrumb();
