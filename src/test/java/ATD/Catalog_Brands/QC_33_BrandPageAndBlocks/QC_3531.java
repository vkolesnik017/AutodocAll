...
public class QC_3531 {
    ...
    Object[] dataProvider() throws SQLException {
        //return new SetUp("ATD").setUpShopWithSubroutes("prod", "DE", "main", "category_model_brand");   // НУЖНО ПРОСТАВИТЬ ПРАВИЛЬНЫЙ РУТ ИЗ БД
        return new Object[][]{{"https://www.autodoc.de/autoteile/bremsscheibe-10132/bmw/8-e31/8-e31-1990/mf-stark"}};
    }

    @Test(dataProvider = "routes")
    @Flaky
    @Owner(value = "Kolesnik")
    @Description(value = "Test checks displaying and transition of brands block on category_model_brand route")
