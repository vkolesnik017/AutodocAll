...
public class QC_1487_ChecksVerificationIslands_BillingIsUndivided_PositiveCase_ATD {

    private String email = "QC_1487_autotest@autodoc.si", orderNumber;
    ...
    public void testChecksVerificationIslandsBillingIsUndividedPositiveCas(String route) {
        ...
        totalPriceInEmail = new WebMail().openMail("QC_1487_autotest@autodoc.si", passwordForMail)
