...
public class QC_3080 {
    ...
    void setUp() throws SQLException {
        ...
        String mail = "QC_3080_autotest@mailinator.com";
    ...
    public void testCheckingWordPackstationIsNotBlockedOnBilling(String blockingWords) {
        cartAddress_page_logic.clickCheckboxForOpenBilling()
                .fillAllFieldsForShipping("autotest", "autotest", "street", "autotest",
                        "DE", "city", "200+002")
                .fillAllFieldsForBilling("autotest", "autotest", blockingWords, "autotest",
                        "DE", "city", "100+001")
                .nextBtnClick();
