...
public class QC_2730 {
    ...
    public void testCheckingForNoFreeSO_withATD_Basik(String route) throws SQLException {
        openPage(route);
        String mail = "qc_2730_autotestbasik@mailinator.com";
    ...
    public void testCheckingForNoFreeSO_withATD_OPTIMUM(String route) throws SQLException {
        openPage(route);
        String mail = "qc_2730_autotestoptimum@mailinator.com";
        String shop = getCurrentShopFromJSVarInHTML();
        String soPrise = new Versand_static_page_Logic().getSafeOrderPrice();
        openPage(bd.getFullRouteByRouteAndSubroute("prod", shop, "main", "product32"));
        String orderID = product_page_logic.addProductToCart()
    ...
    public void testCheckingForNoFreeSO_withATD_TRIAL(String route) throws SQLException {
        openPage(route);
        String mail = "qc_2730_autotesttrial@mailinator.com";
        String shop = getCurrentShopFromJSVarInHTML();
        String soPrise = new Versand_static_page_Logic().getSafeOrderPrice();
        openPage(bd.getFullRouteByRouteAndSubroute("prod", shop, "main", "product32"));
        String orderID = product_page_logic.addProductToCart()
    ...
    public void testCheckingForNoFreeSO_withATD_PRO(String route) throws SQLException {
        openPage(route);
        String mail = "qc_2730_autotestpro@mailinator.com";
        String shop = getCurrentShopFromJSVarInHTML();
        String soPrise = new Versand_static_page_Logic().getSafeOrderPrice();
        openPage(bd.getFullRouteByRouteAndSubroute("prod", shop, "main", "product32"));
        String orderID = product_page_logic.addProductToCart()
