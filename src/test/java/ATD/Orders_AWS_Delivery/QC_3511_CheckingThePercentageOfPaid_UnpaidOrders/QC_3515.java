...
public class QC_3515 {
    ...
    @Description(value = "Checking the percentage of paid/unpaid orders Klarna")
    public void testCheckingThePercentageOfPaid_UnpaidOrders_Klarna() {
