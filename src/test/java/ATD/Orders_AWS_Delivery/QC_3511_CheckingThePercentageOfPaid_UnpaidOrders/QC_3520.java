...
public class QC_3520 {
    ...
    @Description(value = "Checking the percentage of paid/unpaid orders Be2bill[SEK] (Visa/MC)")
    public void testCheckingThePercentageOfPaid_UnpaidOrders_Be2bill_SEK_Visa_MC() {
        ...
        searchOrdersPageAws.openSearchPageWithExpectedData(data, data)
                ...
                .choosePaymentsMethods("Be2bill[SEK] (Visa/MC)")
                .clickSearchBtn()
