...
public class QC_3517 {
    ...
    @Description(value = "Checking the percentage of paid/unpaid orders Trustly")
    public void testCheckingThePercentageOfPaid_UnpaidOrders_Trustly() {
