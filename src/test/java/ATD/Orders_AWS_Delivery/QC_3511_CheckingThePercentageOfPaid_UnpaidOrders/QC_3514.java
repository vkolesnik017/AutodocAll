...
public class QC_3514 {
    ...
    @Description(value = "Checking the percentage of paid/unpaid orders PayPal")
    public void testCheckingThePercentageOfPaid_UnpaidOrders_PayPal() {
