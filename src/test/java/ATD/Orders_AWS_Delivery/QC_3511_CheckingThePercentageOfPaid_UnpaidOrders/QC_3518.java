...
public class QC_3518 {
    ...
    @Description(value = "Checking the percentage of paid/unpaid orders Be2bill")
    public void testCheckingThePercentageOfPaid_UnpaidOrders_Be2bill() {
