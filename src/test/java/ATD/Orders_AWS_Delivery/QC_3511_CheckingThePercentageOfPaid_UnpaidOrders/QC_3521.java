...
public class QC_3521 {
    ...
    @Description(value = "Checking the percentage of paid/unpaid orders Be2bill[HUF] (Visa/MC) ")
    public void testCheckingThePercentageOfPaid_UnpaidOrders_Be2bill_HUF_Visa_MC() {
        ...
        searchOrdersPageAws.openSearchPageWithExpectedData(data, data)
                ...
                .choosePaymentsMethods("Be2bill[HUF] (Visa/MC)")
                .clickSearchBtn()
