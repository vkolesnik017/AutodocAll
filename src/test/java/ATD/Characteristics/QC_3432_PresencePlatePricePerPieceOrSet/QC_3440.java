...
public class QC_3440 {
    ...
    public void testCheckDisplayPricePerPieceElementInTopProductsBlock(String route) {
        ...
        new LKW_Category_car_list_page_Logic()
                .checkPresenceElementPricePerSetOrPiece(new Category_name_page_Logic().infoPriceForPieceFromTopProduct());
    }
    ...
    public void testLkwCheckDisplayPricePerPieceElementInTopProductsBlock(String route) {
        openPage(route);
        new LKW_Category_car_list_page_Logic()
                .checkPresenceElementPricePerSetOrPiece(new LKW_Category_page_Logic().infoPriceForPieceFromTopProduct());
