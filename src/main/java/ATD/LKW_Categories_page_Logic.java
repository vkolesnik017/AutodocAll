...
public class LKW_Categories_page_Logic extends LKW_Categories_page {
    ...
    public LKW_Categories_page_Logic transitionToProductPageByClickOnTopImage() {
        clickOnImageOfTopProduct().checkSuccessfullyLKWProductPageLoading("https://lkwteile.autodoc.de/dt/");
        back();
        return this;
    }
    ...
    public LKW_Categories_page_Logic transitionToProductPageByClickOnTitleOfTopProduct() {
        ...
        clickOnTitleOfTopProduct().checkSuccessfullyLKWProductPageLoading("https://lkwteile.autodoc.de/dt/");
        back();
        return this;
    }
    ...
    public LKW_Categories_page_Logic transitionToProductPageByClickOnLinkDetails() {
        ...
        clickOnLinkDetails().checkSuccessfullyLKWProductPageLoading("https://lkwteile.autodoc.de/dt/");
        back();
        return this;
    }
